...
/* @var $model app\models\Bonossearch */
...
<div class="bonos-search">
      ...
      <?php
      echo $form->field($model, 'MesPeriodoBono')->widget(Select2::classname(), [
          'data' => $data = [
              "Enero" => "Enero",
              "Febrero" => "Febrero",
              "Marzo" => "Marzo",
      ...
      ?>
          ...
          <?php
      echo $form->field($model, 'AnoPeriodoBono')->widget(Select2::classname(), [
          'data' => $data = [
              "2018" => "2018",
              "2019" => "2019",
              "2020" => "2020",
