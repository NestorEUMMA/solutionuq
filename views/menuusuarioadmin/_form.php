  ...
  <div class="form-group">
                 ...
                 <?php
                    echo $form->field($model, 'IdUsuario')->widget(Select2::classname(), [
                        'data' => ArrayHelper::map(Usuario::find()->where(['Activo' => 1])->andWhere(['LexaAdmin' => 1])->all(), 'IdUsuario', 'InicioSesion'),
                        'language' => 'es',
                ...
                <?php
                    $catList=ArrayHelper::map(app\models\Menu::find()->all(), 'IdMenu', 'DescripcionMenu' );
