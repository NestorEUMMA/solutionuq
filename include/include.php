<?php
  ...
  $ruta = 'http://localhost/solucionuq/';
...
<link href="../../web/template/css/plugins/fullcalendar/fullcalendar.css" rel="stylesheet">
<link href="../../web/template/css/plugins/fullcalendar/fullcalendar.print.css" rel='stylesheet' media='print'>
...
<script src="../../web/template/js/plugins/jquery-ui/jquery-ui.min.js"></script>
<script src="../../web/template/js/plugins/iCheck/icheck.min.js"></script>
<script src="../../web/template/js/plugins/fullcalendar/fullcalendar.min.js"></script>
