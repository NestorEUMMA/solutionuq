...
session_start();
    ...
    $anio = date("Y");
		...
		$insertplanilla = "INSERT INTO planilla(IdEmpleado, FechaTransaccion, Anticipos, MesPlanilla, AnioPlanilla)"
											 . "VALUES ('$Empleado','$Fecha', '$Antncipos','$mes', '$anio')";
		$resultadoinsertplanilla = $mysqli->query($insertplanilla);

    $insert = "INSERT INTO anticipos(IdEmpleado, FechaAnticipos, MontoAnticipo, MesPeriodoAnticipo, AnoPeriodoAnticipo)"
                       . "VALUES ('$Empleado','$Fecha', '$Antncipos','$mes', '$anio')";
    $resultadoinsert = $mysqli->query($insert);
    $last_id = $mysqli->insert_id;

    header('Location: ../../web/anticipos/view?id='.$last_id);
