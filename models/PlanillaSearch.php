...
/**
 * PlanillaSearch represents the model behind the search form of `app\models\Planilla`.
 */
class PlanillaSearch extends Planilla
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'MesPlanilla', $this->MesPlanilla])
            ...
            ->andFilterWhere(['like', 'DiasIncapacidad', $this->DiasIncapacidad]);
