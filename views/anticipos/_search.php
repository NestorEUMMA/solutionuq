...
/* @var $model app\models\AnticiposSearch */
...
<div class="anticipos-search">
  ...
  <?php
  echo $form->field($model, 'MesPeriodoAnticipo')->widget(Select2::classname(), [
      'data' => $data = [
          "Enero" => "Enero",
          "Febrero" => "Febrero",
          "Marzo" => "Marzo",
  ...
  ?>
      ...
      <?php
  echo $form->field($model, 'AnoPeriodoAnticipo')->widget(Select2::classname(), [
      'data' => $data = [
          "2018" => "2018",
          "2019" => "2019",
          "2020" => "2020",
