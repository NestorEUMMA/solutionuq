...
class EmpleadoSearch extends Empleado
{
    ...
    {
        return [
            [['IdEmpleado', 'IdTipoDocumento', 'IdInstitucionPre', 'IdTipoEmpleado', 'IdEstadoCivil', 'IdDepartamentoEmpresa', 'IdPuestoEmpresa', 'IdBanco', 'JefeInmediato','IdEmpresa','IdUsuario'], 'integer'],
